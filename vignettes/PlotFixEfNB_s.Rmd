---
title: "Plotting Fixed Effects Solutions For Carcass Natura-Beef (sire)"
output: 
  pdf_document:
    pandoc_args: [ 
      "--output=PlotFixEfNB_s.pdf" 
    ]
vignette: >
  %\VignetteIndexEntry{Plotting Fixed Effects Solutions For Carcass Natura-Beef (sire)}
...
# Parameters
vec_dir <- "../inst/extdata/NaturaBeef_s/"
